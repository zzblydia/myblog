...
void Welcome(Player &player, std::vector<Location *> &locations) {
    ...
    std::cout << "Welcome to the Adventure Game. The aim is to defeat to Boss, ";
    std::cout << "but your score points for defeating monsters along th way." << std::endl;
...
void collect(Player &player) {
    ...
    for (auto &armour: armours) {
        ...
        std::cout << "You collected the " << armour->getName() << "." << std::endl;
