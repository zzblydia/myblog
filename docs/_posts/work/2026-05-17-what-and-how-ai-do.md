...
得益于公司内部搭建的`minimax 2.5`(后来升级到2.7，再后来是`glm5.2`)，大家终于有机会不考虑token开始猛登了，疯狂探索如何使用AI提高开发效率，包括需求内容分析，需求文档编写，开发设计文档审视，代码编写，代码审查，单元测试用例设计，集成测试用例设计，维护文档编写，维护案例总结，开发各种skills（公司内部有skills-market），甚至还会开发mcp。  
